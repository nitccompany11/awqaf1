...
@section('content')
	...
	<div class="col-md-12 text-center content-t card">
		<div class="col-md-12 text-right btnDiv"> <!-- Heading Button -->
			...
			<a href="{{ url('admin/companies/'. $companies->id .'/edit') }}" class="btn btn-info">
			...
			<table id="example1" class="table table-bordered table-striped">
                <tbody>
                	...
                	<tr>
                		...
                		<td>{{ $companies['name_' . getLang()] }}</td>
                	</tr>
                    <tr>
                        <td>{{ trans('admin.url') }}</td>
                        <td>
                            <a href="{{ $companies->url }}" class="btn btn-success">
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $companies['content_' . getLang()] }}
                        </td>
                    </tr>
                    <tr>
                        <td>{{ trans('admin.image') }}</td>
                        <td>
                            <img src="{{ $companies->image }}" width="80">
                        </td>
                    </tr>
                </tbody>
            </table>
