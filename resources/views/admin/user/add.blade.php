		...
		<div class="form card-body pb-2">
			...
			<form class="form-horizontal" method="post" action="{{ url()->current() }}" enctype="multipart/form-data">
				...
				<div class="row row-sm"> <!-- Item -->
					...
					<div class="col-md-9">
						<input type="text" name="name" class="form-control required name" placeholder="{{ trans('admin.name') }}" value="{{ old('name') }}">
					</div>
				</div> <!-- End Item -->
				...
				<div class="row row-sm"> <!-- Item -->
					...
					<div class="col-md-9">
						<input type="email" name="email" class="form-control required" placeholder="{{ trans('admin.email') }}" value="{{ old('email') }}">
					</div>
				</div> <!-- End Item -->
				...
				<div class="row row-sm"> <!-- Item -->
					...
					<div class="col-md-9">
						<input type="number" name="phone" class="form-control required lenght" data-length="10" placeholder="{{ trans('admin.phone') }}" value="{{ old('phone') }}">
				...
				<div class="row row-sm"> <!-- Item -->
					...
					<div class="col-md-9">
						<input type="password" name="password" class="form-control required" placeholder="{{ trans('admin.password') }}">
					</div>
				</div> <!-- End Item -->
				...
				<div class="row row-sm"> <!-- Item -->
					<label class="label label-control col-md-3">{{ trans('admin.userType') }}</label>
					<div class="col-md-9">
						<select name="admin" class="form-control">
							<option value="">{{ trans('admin.userType') }}</option>
				...
				<div class="row row-sm"> <!-- Item -->
					...
					<div class="col-md-9">
						<select name="group_id" class="form-control required">
							...
							<option value="{{ $group->id }}">{{ $group['name_' . getLang()] }}</option>
							@endforeach
						</select>
					</div>
				</div>
