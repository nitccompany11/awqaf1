		...
		<div class="form card-body pb-2">
			...
			<form class="form-horizontal" method="post" action="{{ url()->current() }}" enctype="multipart/form-data">
				...
				<div class="row row-sm"> <!-- Item -->
					...
					<div class="col-md-9">
						<input type="text" name="name_ar" value="{{ $projects->name_ar }}" class="form-control" placeholder="{{ trans('admin.name_ar') }}">
					</div>
				</div> <!-- End Item -->
				...
				<div class="row row-sm"> <!-- Item -->
					...
					<div class="col-md-9">
						<input type="text" name="name_en" value="{{ $projects->name_en }}" class="form-control" placeholder="{{ trans('admin.name_en') }}">
					</div>
				</div> <!-- End Item -->
				...
				<div class="row row-sm"> <!-- Item -->
					...
					<div class="col-md-9">
						<input type="text" name="date_project" class="form-control" placeholder="{{ trans('admin.date') }}" value="{{ $projects->date }}">
					</div>
				</div> <!-- End Item -->
				...
				<div class="row row-sm"> <!-- Item -->
					...
					<div class="col-md-9">
						<textarea class="form-control" name="description_ar" placeholder="{{ trans('admin.description_ar') }}">{{ $projects->description_ar }}</textarea>
					</div>
				</div> <!-- End Item -->
				...
				<div class="row row-sm"> <!-- Item -->
					...
					<div class="col-md-9">
						<textarea class="form-control" name="description_en" placeholder="{{ trans('admin.description_en') }}">{{ $projects->description_en }}</textarea>
					</div>
				</div> <!-- End Item -->
				...
				<div class="row row-sm"> <!-- Item -->
					...
					<div class="col-md-9">
						<textarea class="form-control ckeditor" placeholder="{{ trans('admin.content_ar') }}" name="content_ar">{{ $projects->content_ar }}</textarea>
					</div>
				</div> <!-- End Item -->
				...
				<div class="row row-sm"> <!-- Item -->
					...
					<div class="col-md-9">
						<textarea class="form-control ckeditor" placeholder="{{ trans('admin.content_en') }}" name="content_en">{{ $projects->content_en }}</textarea>
					</div>
				</div> <!-- End Item -->
