...
<html>
<head>
	<title>@if(session()->get('lang') == 'en') {{ getSetting()->site_name_en }} @else {{ getSetting()->site_name_ar }} @endif</title>
</head>
...
<body>
	...
	<section class="error">
	  ...
	  <a href="{{ url('/') }}" style="color: #fff; font-size: 20px; text-decoration: none;">Back To Home Page</a>
	</section>
