<?php $__env->startSection('content'); ?>
	...
	<div class="col-md-12 text-center content-t card">
		<div class="col-md-12 text-right btnDiv"> <!-- Heading Button -->
			...
			<form style="display: inline-block;" method="post" action="<?php echo e(url('admin/projects/deleteAll')); ?>" id="formDeleteAll">
		...
		<div class="col-md-12 contentTable table-responsive"> <!-- Content -->
			...
			<table class="table table-bordered text-nowrap border-bottom" id="responsive-datatable">
                ...
                <tbody>
                	...
                	<?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                <tr>
	                	<td>
	                		<input type="checkbox" class="inputUser" name="projects[]" value="<?php echo e($s->id); ?>" form="formDeleteAll">
	                	</td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\awqaf2\resources\views/admin/projects/index.blade.php ENDPATH**/ ?>