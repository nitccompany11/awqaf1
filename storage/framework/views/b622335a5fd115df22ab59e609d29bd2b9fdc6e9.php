                    ...
                    <a href="<?php echo e(route('get.company', [$company->id, $company->getUrlTitle()])); ?>">
                        <div class="d-flex justify-content-center flex-column align-items-center">
                            <div class="company-img w-50 h-50 d-flex justify-content-center align-items-center mb-4">
                                <img src="<?php echo e($company->image); ?>" alt="<?php echo e($company['name_' . getLang()]); ?>" alt="company 3" class="img-fluid" style="width: 100%;height: 125px;">
                            </div>
...
<?php echo $__env->make('website.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\awqaf2\resources\views/website/companies/index.blade.php ENDPATH**/ ?>