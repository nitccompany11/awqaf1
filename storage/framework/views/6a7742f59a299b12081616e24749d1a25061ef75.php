<?php $__env->startSection('content'); ?>
	...
	<div class="col-md-12 text-center content-t card">
		<div class="col-md-12 text-right btnDiv"> <!-- Heading Button -->
			<a href="<?php echo e(url('admin/user/add')); ?>" class="btn btn-success">
				<i class="fa fa-plus"></i> <?php echo e(trans('admin.addAdmin')); ?> 
			</a>
			<form style="display: inline-block;" method="post" action="<?php echo e(url('admin/user/deleteAll')); ?>" id="formDeleteAll">
			...
			<table class="table table-bordered text-nowrap border-bottom" id="responsive-datatable">
                <thead>
	                <tr>
	                  ...
	                  <th><?php echo e(trans('admin.userType')); ?></th>
                ...
                <tbody>
	                ...
	                <tr>
	                	<td>
	                		<input type="checkbox" class="inputUser" name="user[]" value="<?php echo e($s->id); ?>" form="formDeleteAll">
	                	</td>
	                  ...
	                  <td><?php if(!is_null($s->created_at)): ?><?php echo e($s->created_at->format('Y-m-d')); ?><?php endif; ?></td>
	                  <td>
	                  	<a href="<?php echo e(url('admin/user') . '/' . $s->id . '/show'); ?>" class="btn btn-warning"><i class="fa fa-eye"></i> <?php echo e(trans('admin.show')); ?> </a>

	                  	<a href="<?php echo e(url('admin/user') . '/' . $s->id . '/edit'); ?>" class="btn btn-info"><i class="fa fa-edit"></i> <?php echo e(trans('admin.edit')); ?> </a>

	                  	

	                  	

	                  	<a href="<?php echo e(url('admin/user') . '/' . $s->id . '/delete'); ?>" class="btn btn-danger delete"><i class="fa fa-close"></i> <?php echo e(trans('admin.delete')); ?> </a>
	                  </td>
	                </tr>
	                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	                <?php else: ?> 
	                	<p class="alert alert-warning" style="margin-top: 10px; margin-bottom: 10px"> <?php echo e(trans('admin.noData')); ?> <?php echo e(trans('admin.willAdd')); ?> <a href="<?php echo e(url('admin/user/add')); ?>"> <?php echo e(trans('admin.addAdmin')); ?> </a> </p>
	                <?php endif; ?>	
                </tbody>
             </table>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\awqaf\resources\views/admin/user/admin.blade.php ENDPATH**/ ?>