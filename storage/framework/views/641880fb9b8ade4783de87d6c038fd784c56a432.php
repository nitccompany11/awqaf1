	...
	<div class="col-md-12 text-center content-t card card">
		<div class="form card-body pb-2">
			...
			<form class="form-horizontal" method="post" action="<?php echo e(url()->current()); ?>" enctype="multipart/form-data">
				...
				<input type="hidden" name="id" value="<?php echo e($reports->id); ?>">

				<div class="row row-sm"> <!-- Item -->
					<label class="label label-control col-md-3"> <?php echo e(trans('admin.name_ar')); ?> </label>
					<div class="col-md-9">
						<input type="text" name="name_ar" value="<?php echo e($reports->name_ar); ?>" class="form-control" placeholder="<?php echo e(trans('admin.name_ar')); ?>">
					</div>
				</div> <!-- End Item -->
				...
				<div class="row row-sm"> <!-- Item -->
					...
					<div class="col-md-9">
						<input type="text" name="name_en" value="<?php echo e($reports->name_en); ?>" class="form-control" placeholder="<?php echo e(trans('admin.name_en')); ?>">
					</div>
				</div> <!-- End Item -->
				...
				<div class="row row-sm"> <!-- Item -->
					...
					<div class="col-md-9">
						<input type="text" name="date_project" class="form-control date" placeholder="<?php echo e(trans('admin.date')); ?>" readonly="readonly" value="<?php echo e($reports->date_project); ?>">
					</div>
				</div> <!-- End Item -->
				...
				<div class="row row-sm"> <!-- Item -->
					...
					<div class="col-md-9">
						<img src="<?php echo e($reports->image); ?>" width="150">
					</div>
				</div> <!-- End Item -->

				<div class="row row-sm"> <!-- Item -->
					<label class="label label-control col-md-3"> <?php echo e(trans('admin.file')); ?> </label>
					<div class="col-md-9">
				...
				<div class="row row-sm"> <!-- Item -->
					<label class="label label-control col-md-3"> <?php echo e(trans('admin.fileUse')); ?> </label>
					<div class="col-md-9">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\awqaf\resources\views/admin/reports/edit.blade.php ENDPATH**/ ?>