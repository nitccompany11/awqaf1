<?php $__env->startSection('content'); ?>
	...
	<div class="col-md-12 text-center content-t card">
		<div class="col-md-12 text-right btnDiv"> <!-- Heading Button -->
			<a href="<?php echo e(url('admin/blogs/add')); ?>" class="btn btn-success">
				<i class="fa fa-plus"></i> <?php echo e(trans('admin.addBlog')); ?> 
			</a>
			<form style="display: inline-block;" method="post" action="<?php echo e(url('admin/blogs/deleteAll')); ?>" id="formDeleteAll">
		...
		<div class="col-md-12 contentTable table-responsive"> <!-- Content -->
			...
			<table class="table table-bordered text-nowrap border-bottom" id="responsive-datatable">
                ...
                <tbody>
                	...
                	<?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                <tr>
	                	<td>
	                		<input type="checkbox" class="inputUser" name="blogs[]" value="<?php echo e($s->id); ?>" form="formDeleteAll">
	                	</td>
	                  	<td><?php echo e($s->id); ?></td>
	                  	<td><?php echo e($s['name_' . getLang()]); ?></td>
	                  	<td><?php echo e($s->created_at->format('Y-m-d')); ?></td>
	                  	<td>
		                  	<a href="<?php echo e(url('admin/blogs') . '/' . $s->id . '/show'); ?>" class="btn btn-warning"><i class="fa fa-eye"></i> <?php echo e(trans('admin.show')); ?> </a>

		                  	<a href="<?php echo e(url('admin/blogs') . '/' . $s->id . '/edit'); ?>" class="btn btn-info"><i class="fa fa-edit"></i> <?php echo e(trans('admin.edit')); ?> </a>
		                  	
		                  	<a href="<?php echo e(url('admin/blogs') . '/' . $s->id . '/delete'); ?>" class="btn btn-danger delete"><i class="fa fa-close"></i> <?php echo e(trans('admin.delete')); ?> </a>

		                  	<?php if($s->status == 1): ?>
		                  		<a href="<?php echo e(url('admin/blogs') . '/' . $s->id . '/status'); ?>" class="btn btn-danger">
		                  			<i class="fa fa-close"></i>
		                  		</a>
		                  	<?php else: ?>
		                  		<a href="<?php echo e(url('admin/blogs') . '/' . $s->id . '/status'); ?>" class="btn btn-success">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\awqaf\resources\views/admin/blogs/index.blade.php ENDPATH**/ ?>